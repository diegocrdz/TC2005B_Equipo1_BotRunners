...
class Player extends AnimatedObject {
    ...
    takeDamage(amount) {
        ...
        if (this.health <= 0) {
            ...
            }, 100); // Cooldown period of 1 second
        }
    }
    ...
    useHealthPotion() {
        if (!this.hasUsedPotion && this.health < 100) {
            this.health = this.health +50; // Restore health 50 hp%
            if(this.health > 100){
                this.health = 100; //health cannot be greatet than 100 hp
            }
            this.hasUsedPotion = true; // Mark the potion as used
            game.potionImage.src = '../assets/sprites/potion_empty.png'; // Change the sprite to an empty potion
        }
    }
}
